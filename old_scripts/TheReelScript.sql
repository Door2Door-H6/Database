USE [Door2DoorZbc]
GO
/****** Object:  User [aooadmin]    Script Date: 03/12/2021 16:12:16 ******/
CREATE USER [aooadmin] FOR LOGIN [aooadmin] WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  User [mar]    Script Date: 03/12/2021 16:12:16 ******/
CREATE USER [mar] FOR LOGIN [mar] WITH DEFAULT_SCHEMA=[dbo]
GO
ALTER ROLE [db_ddladmin] ADD MEMBER [mar]
GO
ALTER ROLE [db_datareader] ADD MEMBER [mar]
GO
ALTER ROLE [db_datawriter] ADD MEMBER [mar]
GO
/****** Object:  UserDefinedFunction [dbo].[geometry2json]    Script Date: 03/12/2021 16:12:16 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[geometry_columns]    Script Date: 03/12/2021 16:12:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Level]    Script Date: 03/12/2021 16:12:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[POI]    Script Date: 03/12/2021 16:12:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[POIType]    Script Date: 03/12/2021 16:12:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Room]    Script Date: 03/12/2021 16:12:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RoomLabels]    Script Date: 03/12/2021 16:12:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RoomType]    Script Date: 03/12/2021 16:12:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SolidWalls]    Script Date: 03/12/2021 16:12:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[spatial_ref_sys]    Script Date: 03/12/2021 16:12:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[WalkableArea]    Script Date: 03/12/2021 16:12:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[RoomLabels] ([qgs_fid], [geom], [id], [name]) VALUES (8, 0xE6100000010CE774C867BAADA33FC777D783AC2B943F, 8, N'B08 Køkken')
...
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (1, 0xE61000000104020000002A04503AD4C08A3FFD179DD760B8573FB054A969A1BD8A3F4A2BC3FE7485783F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 1, N'B indgang infostander')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (2, 0xE6100000010402000000B054A969A1BD8A3F4A2BC3FE7485783FFBDD680F6DC38F3FD96493C6D6AB783F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 2, N'B stander')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (3, 0xE6100000010402000000B054A969A1BD8A3F4A2BC3FE7485783F89424D74F6B48A3F4891CD538261883F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 3, N'B30 exit')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (4, 0xE610000001040200000089424D74F6B48A3F4891CD538261883F8EE166381ACC883F56A5AA0D235A883F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 4, N'B30 entry')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (5, 0xE610000001040200000089424D74F6B48A3F4891CD538261883FDAC849B1CDB28A3F5049BC3817118C3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 5, N'B gang cross')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (6, 0xE6100000010402000000DAC849B1CDB28A3F5049BC3817118C3FEAC25ED94FA1803F250EFF8A4EFD8B3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 6, N'B26,depot exit')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (7, 0xE6100000010402000000EAC25ED94FA1803F250EFF8A4EFD8B3FF7DBE243D8A6803F5DFD797CCFDB8D3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 7, N'B26 entry')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (8, 0xE6100000010402000000EAC25ED94FA1803F250EFF8A4EFD8B3F298B7966ABC97E3F21F33BADE0FA8B3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 8, N'depot entry')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (9, 0xE6100000010402000000DAC849B1CDB28A3F5049BC3817118C3F807F6F87B5128F3FE24D343BA0118C3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 9, N'B24 exit')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (10, 0xE6100000010402000000807F6F87B5128F3FE24D343BA0118C3FD8DA3F0CB5168F3F6BB09D6968E18D3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 10, N'B24 entry')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (11, 0xE6100000010402000000807F6F87B5128F3FE24D343BA0118C3F657100E6EF31973F7B51A30F3B128C3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 11, N'B16 exit')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (12, 0xE6100000010402000000657100E6EF31973F7B51A30F3B128C3F53BEEEBC6E32973FD6AC204D02DF8D3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 12, N'B16 entry')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (13, 0xE6100000010402000000657100E6EF31973F7B51A30F3B128C3F14B9FE8C452E9F3F99A587A339138C3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 13, N'B14 , Artrium exit')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (14, 0xE610000001040200000014B9FE8C452E9F3F99A587A339138C3FC1D4F5C046249F3F930474B59BE08D3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 14, N'B24 entry')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (15, 0xE610000001040200000014B9FE8C452E9F3F99A587A339138C3F3F6E2A6AAEBCA43FFE54F5DD58148C3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 15, N'B02,B08,B10,B12 exit')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (16, 0xE61000000104020000003F6E2A6AAEBCA43FFE54F5DD58148C3F484BDF5546BDA43F285429CCA8948F3F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 16, N'B kælder exit')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (17, 0xE6100000010402000000484BDF5546BDA43F285429CCA8948F3F981287E5E1BDA43F7418398D3995913F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 17, N'B02,B08,B10 exit')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (18, 0xE6100000010402000000981287E5E1BDA43F7418398D3995913F189E243FCB17A43F7A4D4688FC93913F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 18, N'B10 exit')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (19, 0xE6100000010402000000189E243FCB17A43F7A4D4688FC93913FF5494EF39718A43F6F5BE6E0E647923F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 19, N'B08 køkken entry')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (20, 0xE6100000010402000000189E243FCB17A43F7A4D4688FC93913F56EA63BBB04AA33FEFCF82BCB495903F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 20, N'B10 exit')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (21, 0xE610000001040200000056EA63BBB04AA33FEFCF82BCB495903FA0F0165124DDA23FBCC88883E890903F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 21, N'B10 entry')
INSERT [dbo].[WalkableArea] ([qgs_fid], [geom], [id], [name]) VALUES (22, 0xE6100000010402000000A0F0165124DDA23FBCC88883E890903F012CD6EE3A21A23F4519E2B2B58D903F01000000010000000002000000FFFFFFFF0000000005000000000000000002, 22, N'B10 point')
...
GO
/****** Object:  StoredProcedure [dbo].[GetCategories]    Script Date: 03/12/2021 16:12:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetPaths]    Script Date: 03/12/2021 16:12:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
set @end  = (select ((select geom from WalkableArea where id = ((select id from WalkableArea where name = @endPoiName + ' entry')))).STEndPoint());
--dijskra testing
...
END
GO
/****** Object:  StoredProcedure [dbo].[GetPois]    Script Date: 03/12/2021 16:12:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
FOR JSON PATH;
GO
/****** Object:  StoredProcedure [dbo].[GetRoomLabels]    Script Date: 03/12/2021 16:12:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
FOR JSON PATH;
GO
/****** Object:  StoredProcedure [dbo].[GetRooms]    Script Date: 03/12/2021 16:12:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
FOR JSON PATH;
GO
/****** Object:  StoredProcedure [dbo].[GetWalls]    Script Date: 03/12/2021 16:12:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
